...
<div id="title-selector">
    <div class="flex-container-title">
        <div class="flex-container-col title-with-tabs">
            ...
            <div>
                {person_time?.count ?? "error"} of {person?.count ?? "N/A"} Photos
                Selected
            </div>
            <div class="flex-container">
                <div class="tabs">
                    ...
                    <button
                        ...
                        on:click={() => setActive("Tab3")}
                        >Numeric Scores</button
                    >
                </div>
            </div>
        </div>
        ...
        <div style="min-width: 20%" class="flex-container-col">
            ...
            <div>
                {#if person_id === "---"}
                    <span style="color: red;">Warning: </span>No face selected,
                    showing stats for all photos combined.
                {:else}
                    <br /><br />
                {/if}
            </div>
