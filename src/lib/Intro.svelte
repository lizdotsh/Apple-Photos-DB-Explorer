...
<div class="instructions-flex">
        ...
        <div>
            <p>
                {#if person.full_name === "All Photos"}
                    <b>You currently have no face/name selected.</b>
                    <p>
                        Showing stats for all photos in your library
                        (face-specific stats may be meaningless)
                    </p>
                {:else}
    ...
    <div class="instructions-div">
        ...
        <p>
            2. Scroll and/or click on the tabs below the app title to see
            different visualizations.
        </p>
        <p>3. Hover over the visualizations to see more information.</p>
        <p>
            4. Use the date selector to scrub through the stats over time as you
            wish. You can also hit 'play' and have it automatically move it for
            you :)
        </p>
    </div>
</div>
